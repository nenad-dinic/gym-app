...
public class TrainingController {
    ...
    TrainingDto.Get getTraining(@RequestParam("id") String id) {
        ...
        return new TrainingDto.Get(t.getId(), t.getName(), t.getTrainers(), t.getDescription(), t.getPic(), t.getPrice(), t.isGroup(), t.getDifficulty(), t.getDuration(), commentRepo.getRatingForTraining(t.getId()));
    }
    ...
    List<TrainingDto.Get> getAvailableTrainings() {
        ...
        for (Training t : trainings) {
            result.add(new TrainingDto.Get(t.getId(), t.getName(), t.getTrainers(), t.getDescription(), t.getPic(), t.getPrice(), t.isGroup(), t.getDifficulty(), t.getDuration(), commentRepo.getRatingForTraining(t.getId())));
        }
        return result;
    }
    ...
    TrainingDto.Get postTraining(@RequestBody TrainingDto.Add data) {
        try {
            ...
            TrainingDto.Get result = new TrainingDto.Get(t.getId(), t.getName(), t.getTrainers(), t.getDescription(), t.getPic(), t.getPrice(), t.isGroup(), t.getDifficulty(), t.getDuration(), 0);
            return result;
        } catch (Exception e) {
            return null;
        }
